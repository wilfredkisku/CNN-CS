...
def SimpleCSNet():
    ...
    conv2 = tf.keras.layers.Conv2D(16, (3,3), padding='same')(conv1)
    conv2 = tf.keras.layers.ReLU()(conv2)

    conv3 = tf.keras.layers.Conv2D(32, (3,3), padding='same')(conv2)
    conv3 = tf.keras.layers.ReLU()(conv3)

    conv4 = tf.keras.layers.Conv2D(32, (3,3), padding='same')(conv3)
    conv4 = tf.keras.layers.ReLU()(conv4)

    conv5 = tf.keras.layers.Conv2D(64, (3,3), padding='same')(conv4)
    conv5 = tf.keras.layers.ReLU()(conv5)

    conv6 = tf.keras.layers.Conv2D(64, (3,3), padding='same')(conv5)
...
'''
    ...
    hist_df.to_csv('/workspace/data/cs-hi-history-500.csv')
    model_cnn.save('/workspace/data/cs-hi-model-500.h5')
